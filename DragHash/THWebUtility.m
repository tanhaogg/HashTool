...
+ (NSData *)cryptorData:(NSData *)data key:(NSData *)key iv:(NSData *)iv operation:(THOperationKind)operation kind:(THCryptorKind)cryKind
{
    ...
    switch (operation)
    {
        case THOperationKindEncrypt: cryOperation = kCCEncrypt; break;
        case THOperationKindDecrypt: cryOperation = kCCDecrypt; break;            
        default: return nil;
    }
